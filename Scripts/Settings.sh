...
# 更改菜单名字
echo -e "\nmsgid \"MosDNS\"" >> luci-app-mosdns/luci-app-mosdns/po/zh_Hans/mosdns.po
echo -e "msgstr \"转发分流\"" >> luci-app-mosdns/luci-app-mosdns/po/zh_Hans/mosdns.po

echo -e "\nmsgid \"Lucky\"" >> luci-app-lucky/luci-app-lucky/po/zh_Hans/lucky.po
echo -e "msgstr \"大吉大利\"" >> luci-app-lucky/luci-app-lucky/po/zh_Hans/lucky.po
...
echo -e "\nmsgid \"Tailscale\"" >> luci-app-tailscale/po/zh_Hans/tailscale.po
echo -e "msgstr \"虚拟组网\"" >> luci-app-tailscale/po/zh_Hans/tailscale.po

echo -e "\nmsgid \"Nikki\"" >> OpenWrt-nikki/luci-app-nikki/po/zh_Hans/nikki.po
echo -e "msgstr \"科学上网\"" >> OpenWrt-nikki/luci-app-nikki/po/zh_Hans/nikki.po
